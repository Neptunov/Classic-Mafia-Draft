...
export const en = {
  lobby: {
    ...
    waitingSubtitle: "Device '{device}' is registered in {room}. Waiting for assignment...",
  ...
  judge: {
    ...
    forcePickConfirm: "Are you sure you want to force a random pick for the current player?",
